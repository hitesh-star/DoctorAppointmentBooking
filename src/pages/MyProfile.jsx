...
const MyProfile = () => {
    const [userData, setUserData] = useState({
        ...
        address: {
            ...
            line2: "Cirlce, Church Road, London",
        },
        gender: 'Male',
        dob: '2000-01-20',
    });
    ...
    return (
        <div className='max-w-lg flex flex-col gap-2 text-sm'>
            ...
            {
                isEdit ? <input className='bg-gray-50 text-3xl font-medium max-w-60 mt-4' type="text" value={userData.name} onChange={(e) => setUserData(prev => ({ ...prev, name: e.target.value }))} /> : <p className='font-medium text-3xl text-neutra;-800 mt-4'>{userData.name}</p>
            }
